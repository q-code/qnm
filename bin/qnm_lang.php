...
//$arrLang['es'] = array('ES', 'Espa&ntilde;ol', 'espanol');
//$arrLang['pt'] = array('PT', 'Portugu&ecirc;s', 'portuguese');
//$arrLang['de'] = array('DE', 'Deutsch', 'deutsch');
//$arrLang['it'] = array('IT', 'Italiano', 'italiano');
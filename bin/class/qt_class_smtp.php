...
* qt_class_smtp.php
* ------------
* version: 4.1 build:20121218
* This is a library of public functions
* ------------
* QTmail formats and sends the mail with respect to the method (mail, or smtp)
*
* $strTo: destination
* $strSubject: subject, (included after the team name)
* $strMessage: the message body
* $strCharset: charset added to the header
* $strSMTP: method ('' as configured, '1' force SMTP, '0' force mail)
*/

function QTmail($strTo,$strSubject,$strMessage,$strCharset='iso-8859-1',$strSMTP='')
{
  $strHeaders = 'Content-Type: text/plain; charset='.$strCharset;
  if ( $strSMTP==='' ) $strSMTP = $_SESSION[QT]['use_smtp'];

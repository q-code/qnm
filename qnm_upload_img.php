...
/**
 * QNM (QTE v2.5). This is included in qnm_adm_section_img.php and qnm_user_image.php
...
if (isset($_POST['upload']))
{
  ...
  if ( empty($error) )
  {
    ...
    if ( $width<=$thumb_max_width && $height<=$thumb_max_height )
    {
      ...
      saveThumbnail($id,$thumb_image_location);
    }
    else
    {
...
if (isset($_POST['upload_thumbnail']) && strlen($large_photo_exists)>0)
{
  ...
  // Save
  saveThumbnail($id,$upload_path.$id.$_SESSION['temp_ext']); // The function saveThumbnail() must be defined in the parent page.
...
$oHtml->scripts[] = '<script type="text/javascript" src="bin/js/jquery_imgareaselect.js"></script>
...
<table class="hidden">
<tr class="hidden">
<td class="hidden" style="width:200px;">',AsImgBox(AsImg($photo),'picbox','float:left;min-height:80px',$photolabel),'</td>
...
<table class="hidden">
<tr class="hidden">
<td class="hidden" style="width:200px"><div style="border:1px #e5e5e5 solid; overflow:hidden; width:'.$thumb_width.'px; height:'.$thumb_height.'px;"><img id="preview" src="'.$large_image_location.'" style="position: relative;" alt="Thumbnail Preview" /></div></td>
<td class="hidden">

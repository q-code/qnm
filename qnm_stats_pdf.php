...
require_once 'bin/qt_lib_pdf.php';
...
include 'qnm_stats_inc.php'; // Statistic computation
...
// Table body messages
  ...
  $arrRow = array();
  $oCell = new cPdfCell($L['Notes'],28,5,'',true); $arrRow[]=$oCell;
...
elseif ( file_exists('bin/qt_lib_graph.php') && file_exists($_SESSION[QT]['skin_dir'].'/qnm_main2.css') )
{
...
{
  $pdf->SetFont('Arial','',8);
  $pdf->Cell(0, 10, PdfClean('Graphs cannot be displayed because one of these files is missing: bin/qt_lib_graph.php, '.$_SESSION[QT]['skin_dir'].'/qnm_main2.css'), 'T', 1);
}
